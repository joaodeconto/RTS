	...
	public void InstanceGhostFactory (Hashtable ht)
	{
		...
		if (gameplayManager.resources.CanBuy (factoryConstruct.costOfResources))
		{
			...
			if (PhotonNetwork.offlineMode)
				...
				ghostFactory = PhotonNetwork.Instantiate ( factoryConstruct.factory.gameObject.name, factoryConstruct.factory.transform.position, factoryConstruct.factory.transform.rotation, 0);
