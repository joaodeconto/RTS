...
#ifdef UNITY_VERSION
#define EVERYPLAY_UNITY_VERSION UNITY_VERSION
#else
#include "EveryplayConfig.h"
#endif

#if !defined(EVERYPLAY_UNITY_VERSION) || EVERYPLAY_UNITY_VERSION == 0
...
#if EVERYPLAY_UNITY_VERSION >= 410
...
#if EVERYPLAY_UNITY_VERSION >= 450
...
#if EVERYPLAY_UNITY_VERSION >= 420
...
#if EVERYPLAY_UNITY_VERSION == 350
...
#if EVERYPLAY_UNITY_VERSION >= 430
