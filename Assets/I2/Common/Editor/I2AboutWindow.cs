	...
	public class I2AboutWindow	: EditorWindow
	{
		...
		static void LoadDefaultData ()
		{
			...
			PluginsData.Plugins [0] = new PluginData () {
				...
				DocumentationURL = "http://www.inter-illusion.com/assets/I2Localization.pdf",
				...
				AssetStoreVersion = "2.4.4 f1",
				BetaVersion = "2.4.4 f1"
			};
			PluginsData.Plugins [1] = new PluginData () {
				Name = "SmartEdge",
				Description = "Pixel Perfect Styles for TEXT, SPRITES and IMAGES",
				TrailerURL = "https://www.youtube.com/channel/UCBYYngAJJjCuoZhu1UbwoAw",
				DocumentationURL = "http://inter-illusion.com", //"http://inter-illusion.com/assets/SmartEdgeManual/SmartEdge.html",
				TutorialsURL = "http://inter-illusion.com",//"http://inter-illusion.com/assets/SmartEdgeManual/SmartEdge.html",
				ForumURL = "http://www.inter-illusion.com/forum/smart-edge",
				AssetStoreURL = "https://www.assetstore.unity3d.com/en/#!/publisher/5916",
