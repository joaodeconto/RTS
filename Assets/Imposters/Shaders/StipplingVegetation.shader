// Stippling Vegetation shader for Automatic 3D Billboard Imposters
// Assign this to the model material
// By CWKX

Shader "StipplingVegetation"
{
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fixed4 frag(v2f input) : COLOR
			{
				...
				clip (c.a < _Cutoff || _Stippling < tex2D(_StipplingNoise, input.uv.xy).a ? -1 : 1); 
